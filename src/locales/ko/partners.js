export default{
    'Join the Violas Association':'Violas 에 가입하여 함께합시다.',
    ...
    'Stablecoin issuers':'스테이블코인 발행자',
    'Stablecoin issuers1':'스테이블코인의 발행자들은 조직이거나 개인일 수 있습니다. 스테이블코인을 발행하기 위해 요구되는 자산 준비금은 현지의 법정 통화 또는 협회에서 보증하는 저위험 단기 채권이어야 합니다.',
    'Stablecoin issuers2':'스테이블코인의 발행자는 준비 자산의 안정적인 가치를 보증해야 하며, 해당 자산은 사소한 변동만 경험할 수 있습니다. 발행자들은 준비금이 불충분한 경우에는 이를 공개하고 자산을 보충할 의무가 있습니다.',
    'Stablecoin issuers3':'각각의 스테이블코인 제공은 모든 현지 법률 및 규정을 준수해야 합니다.',
    'Stablecoin issuers4':'스테이블코인의 발행자들은 자신들의 준비 자산과 스테이블 코인의 유통으로부터 생성되는 수익으로부터 이자를 얻을 수 있습니다.',
    'Application Developer':'운영자',
    'Application Developer1':'애플리케이션 개발자들은 각각의 스테이블코인 발행자와 계약을 협상해야 하고 모든 현지 법률 및규정을 준수해야 합니다.'
}