export default{
    ...
    'Custodial Services for Compliant Assets1':'ステーブルコインの発行のために担保資産を提供する者は、その国の法規を遵守しなければならない。また、VIOLASアソシエイトの承認を必要とする。これらの出資者は、その提供する財産が生み出すサービスに対して、対価を請求することができる。',
    'Stablecoin issuers':'ステーブルコインの発行者',
    'Stablecoin issuers1':'ステーブルコインの発行者は、法人または個人とする。ステーブルコイン発行のために必要な担保資産は、現地通貨またはアソシエイトによって認証された低リスクの短期債であることを要する。',
    'Stablecoin issuers2':'ステーブルコインの発行者は、担保資産の安定した価値を保証しなければならない。つまい、担保資産の時価の変動は、軽微であることを要する。発行者は、担保資産に欠損が生じた場合には、すみやかに資産価値を開示し、填補する責任を有する。',
    'Stablecoin issuers3':'各国でのステーブルコインの募集は、現地の法令を遵守しなければならない。',
    'Stablecoin issuers4':'ステーブルコインの発行者は、担保資産から生じる利子およびステーブルコインの流通過程において収益することができる。',
    'Application Developer':'アプリケーション運営側',
    'Application Developer1':'アプリケーション開発者は、各国のステーブルコイン発行者と契約し、現地の法令および規制を遵守しなければならない。'
}